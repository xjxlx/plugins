...
group = common.Config.Publish.GROUP
version = common.Config.Publish.PUBLISH_CODE
...
gradlePlugin {
    ...
    plugins {
        ...
        create(common.Config.Publish.PUBLISH) {
            // 	设置插件的唯一性。id
            id = "${common.Config.Publish.GROUP}.${common.Config.Publish.PUBLISH}"
            // 短名称显示
